    ...
    class RoboDeImportacao
    {
        internal static void importacao()
        {
            ...
            while (n < loop)
            {
                ...
                Console.WriteLine($"{n * tamanhoPacote} entidades importadas para contact!");
                n++;
            }
            ...
            while (n < loop)
            {
                ...
                Console.WriteLine($"{n * tamanhoPacote} entidades importadas para account!");
                n++;
            }
            ...
            while (n < loop)
            {
                ...
                Console.WriteLine($"{n * tamanhoPacote} entidades importadas para lead!");
                n++;
            }
            ...
            while (n < loop)
            {
                ...
                Console.WriteLine($"{n * tamanhoPacote} entidades importadas para salesorder!");
                n++;
            }
            ...
            while (n < loop)
            {
                ...
                Console.WriteLine($"{n * tamanhoPacote} entidades importadas para salesorderdetail!");
                n++;
            }
        ...
        static EntityCollection ImportaAccount(EntityCollection query, int tamanhoPacote, int contador)
        {
            ...
            for (int i = 0; i < tamanhoPacote; i++)
            {
                ...
                entidade.Attributes.Add("cred2_cnpj", query[contador]["crb79_cnpj"].ToString());
                entidade.Attributes.Add("telephone1", query[contador]["telephone1"].ToString());
                entidade.Attributes.Add("emailaddress1", query[contador]["address1_postalcode"].ToString());
                entidade.Attributes.Add("address1_postalcode", query[contador]["address1_postalcode"].ToString());
                entidade.Attributes.Add("address1_line1", query[contador]["address1_line1"].ToString());
                entidade.Attributes.Add("address1_line2", query[contador]["address1_line2"].ToString());
                entidade.Attributes.Add("address1_line3", query[contador]["address1_line3"].ToString());
                entidade.Attributes.Add("address1_city", query[contador]["address1_city"].ToString());
                entidade.Attributes.Add("address1_stateorprovince", query[contador]["address1_stateorprovince"].ToString());
                entidade.Attributes.Add("address1_country", "Brasil");
        ...
        static EntityCollection ImportaUnidadePadrao(EntityCollection query, int tamanhoPacote, int contador)
        {
            ...
            for (int i = 0; i < tamanhoPacote; i++)
            {
                ...
                entidade.Attributes.Add("name", query[contador]["name"]);
                entidade.Attributes.Add("uomscheduleid", query[contador]["uomscheduleid"]);
        ...
        static EntityCollection ImportaGrupoUnidades(EntityCollection query, int tamanhoPacote, int contador)
        {
            ...
            for (int i = 0; i < tamanhoPacote; i++)
            {
                ...
                entidade.Attributes.Add("name", query[contador]["name"]);
                entidade.Attributes.Add("baseuomname", query[contador]["baseuomname"]);
                entidade.Id = query[contador].Id;
                colecaoEntidades.Entities.Add(entidade);
                contador++;
            }
        ...
        static EntityCollection ImportaProduto(EntityCollection query, int tamanhoPacote, int contador)
        {
            contador *= tamanhoPacote;
            EntityCollection colecaoEntidades = new EntityCollection();
            for (var i = 0; i < tamanhoPacote; i++)
            {
                Entity entidade = new Entity("product");
                entidade.Attributes.Add("name", query[contador]["name"]);
                entidade.Attributes.Add("productnumber", query[contador]["productnumber"]);
                ...
                entidade.Attributes.Add("quantitydecimal", query[contador]["quantitydecimal"]);
                entidade.Id = query[contador].Id;
                colecaoEntidades.Entities.Add(entidade);
                contador++;
            }
